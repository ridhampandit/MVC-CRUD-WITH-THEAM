                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form method="POST" enctype="multipart/form-data" id="frm">
                                ...
                                <label class="form-label" for="fname">Firstname</label>
                                    <input type="text" class="form-control" value="<?php echo $employee["firstname"] ?>" id="fname" placeholder="Firstname" name="firstname">
                                    <span class="error-message-fname"></span>
                                </div>
                                <div class="mb-3">
                                <label class="form-label">Lastname</label>
                                    <input type="text" class="form-control" value="<?php echo $employee["lastname"] ?>" id="lname" placeholder="Lastname" name="lastname">
                                    <span class="error-message-lname"></span>                                
                                </div>
                                <div class="mb-3">
                                <label class="form-label">Number</label>
                                    <input type="text" class="form-control" id="number" value="<?php echo $employee["number"] ?>" placeholder="Number" name="number">
                                    <span class="error-message-number"></span>                                
                                </div>
                                <div class="mb-3">
                                <label class="form-label">Email</label>
                                    <input type="email" class="form-control" value="<?php echo $employee["email"] ?>" id="email" placeholder="Email" name="email">
                                    <span class="error-message-email"></span>                                
                                </div>
                                <div class="mb-3">
                                <label class="form-label">Password</label>
                                    <input type="password" name="password" value="<?php echo $employee["password"] ?>" id="password" class="form-control" placeholder="Password" value="">
                                    <span class="error-message-password"></span>                                
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Selete States</label>
                                     <select name="states[]" id="states" class="form-control multiple-select">     
                                     <option value="<?php echo $employee['states']; ?>"><?php echo $employee['states']; ?></option>        
                                         <?php 
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="myCKEditor" value="" id="myCKEditor" rows="2" cols="20"><?php echo $employee["address"]; ?></textarea>
                                    <span class="error-message-address"></span>
                                </div>
                                <div class="mb-3" id="1">
                                    <label class="form-lable">Hobbies:</label>
                                    <input class="form-check-input" id="hobbies" type="checkbox" name="hobbies[]" value="cricket" > 
                                    <label class="form-check-label" for="cricket">
                                     Cricket
                                    </label>
                                    <input class="form-check-input" id="hobbies" type="checkbox" name="hobbies[]" value="music"
                                    <?php                         
                                    // if($employee['hobbies'] == "music"){
                                    //     echo "checked";
                                    // }
                                    ?>
                                    >
                                ...
                                <div class="mb-3">
                                 ...
                                 <div class="mb-3">
                                      ...
                                      <input type="file" name="image" id="image" class="form-control">
                                        <img src="<?php echo "view/upload/". $employee['image'];?>"  width="200px" alt='image' class="img-thumbnail">
                                      <span class="error-message-image"></span>
                                </div>
                                <div class="text-center">
                                <button type="submit" class="btn btn-primary" name="submit" id="submit">submit</button>
                                <a href="index.php" class="btn btn-info col-md-1">Back</a>
                                </div>
                            </form>
                        </div>
                    </div>
